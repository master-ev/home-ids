...
ALL_SETS = [SET_BASE, SET_BASE_CONTEXT, SET_NO_DIRECTION_CONTEXT]
SET_DESCRIPTIONS = {SET_BASE: "original per-flow features", SET_BASE_CONTEXT: "original + context", SET_NO_DIRECTION_CONTEXT: "no backward/port features + context",}
