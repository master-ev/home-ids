from live_ids import(choose_campaign_label, ANOMALY_VERDICT, SUSPICIOUS_MIN_FLOWS, MIN_ATTACK_FLOWS, FEW_PORTS_MAX, DOS_VERDICT, SCAN_MIN_PORTS, SCAN_VERDICT)
