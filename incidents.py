...
EVASION_MARKERS = [FRAGMENT_MARKER, STEALTH_MARKER, ACK_SCAN_MARKER]
FLOOD_MARKER = "flood"
SLOWLORIS_MARKER = "slowloris"
HIGH_IMPACT_MARKERS = [DOS_MARKER, FLOOD_MARKER, SLOWLORIS_MARKER]
...
def is_high_impact(attack_type):
